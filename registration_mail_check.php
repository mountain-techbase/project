...
if (count($errors) === 0){
    ...
    $url = "https://tb-210068.tech-base.net/new.php";
    ...
    $returnMail = 'zkghimawari@gmail.com';

    $name = "テスト";
    $mail = 'zkghimawari@gmail.com';
    $subject = "会員登録用URLのお知らせ";
    //メールの宛先

    $body = "メールに記載されたURLからご登録下さい。\n https://tb-210068.tech-base.net/new.php";
    $from  = "From: zkghimawari@gmail.com\r\n";
    $from .= "Return-Path: zkghimawari@gmail.com";
    ...
    $mailer->Username = 'zkghimawari@gmail.com'; // Gmailのユーザー名
    ...
    //メール本体
    $message=$body;//メール本文
    $mailer->From     = 'zkghimawari@gmail.com'; //差出人の設定
    $mailer->FromName = mb_convert_encoding("テスト","UTF-8","AUTO");//表示名おまじない付…
